...
void ABountyDashObject::MyOnActorOverlap(AActor* targetActor, AActor* otherActor) {

}

void ABountyDashObject::MyOnActorEndOverlap(AActor* targetActor, AActor* otherActor) {
