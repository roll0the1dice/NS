...
void ACoinSpawner::BeginPlay()
{
	...
	for (TActorIterator<AAFloor> FloorIter(GetWorld()); FloorIter; ++FloorIter) {
...
//  Each time a coin has spawned, we decremented the NumCoinsToSpawn variable. 
//  Once this value has reached 0 or lower, we swap our timers again.
